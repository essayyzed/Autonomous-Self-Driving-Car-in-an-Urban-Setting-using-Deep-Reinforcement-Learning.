...
from carla_dqn import CarEnv, MEMORY_FRACTION


MODEL_PATH = 'models/Xception__-155.00max_-177.50avg_-200.00min__1646646710.model'
...
if __name__ == '__main__':
    ...
    while True:
        ...
        while True:
            ...
            print(
                f'Agent: {len(fps_counter)/sum(fps_counter):>4.1f} FPS | Action: [{qs[0]:>5.2f}, {qs[1]:>5.2f}, {qs[2]:>5.2f}] {action}')
