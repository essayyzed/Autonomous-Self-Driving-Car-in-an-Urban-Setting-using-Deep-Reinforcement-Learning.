...
class ModifiedTensorBoard(TensorBoard):
    ...
    def __init__(self, **kwargs):
        ...
        self.writer = tf.compat.v2.summary.create_file_writer(
            logdir=self.log_dir)
        # self.writer = tf.contrib.summary(self.log_dir)
        ...
        #try:
            ...
            if not episode % AGGREGATE_STATS_EVERY or episode == 1:
                ...
                if min_reward >= MIN_REWARD:
                    agent.model.save(
                        f'models/{MODEL_NAME}__{max_reward:_>7.2f}max_{average_reward:_>7.2f}avg_{min_reward:_>7.2f}min__{int(time.time())}.model', save_format='h5')
