...
for i in range(0, 25000, 10):
    ...
    for x, x_vals in enumerate(q_table):
        for y, y_vals in enumerate(x_vals):
            ...
            ax2.scatter(x, y, c=get_q_color(y_vals[1], y_vals)[
                        0], marker="o", alpha=get_q_color(y_vals[1], y_vals)[1])
            ax3.scatter(x, y, c=get_q_color(y_vals[2], y_vals)[
                        0], marker="o", alpha=get_q_color(y_vals[2], y_vals)[1])
